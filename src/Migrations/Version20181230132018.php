 ...
 */
final class Version20181230132018 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD address VARCHAR(255) DEFAULT NULL, ADD city VARCHAR(50) DEFAULT NULL, ADD phone VARCHAR(20) DEFAULT NULL');
    }
